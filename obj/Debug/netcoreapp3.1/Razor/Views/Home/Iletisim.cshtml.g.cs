#pragma checksum "C:\Users\ohl\Desktop\Proje\MyWebSite\MyWebSite\Views\Home\Iletisim.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1a7bff21259a99590e2e3a503e581d95d80a9edc"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1a7bff21259a99590e2e3a503e581d95d80a9edc", @"/Views/Home/Iletisim.cshtml")]
...
#nullable disable
        ...
        ");
            WriteLiteral(@"                    <input type=""email"" id=""Email"" required class=""form-control "">
                        </div>
                        <div class=""col-md-6 form-group"">
                    ...
                    <div class=""row"">
                        <div class=""col-md-12 form-group"">
                            ...
                            <input type=""text"" id=""About"" required class=""form-control"">
                        </div>
                    </div>

                    <div class=""row"">
                        <div class=""col-md-12 form-group"">
                            <label for=""Message"">Mesaj</labe");
            WriteLiteral(@"l>
                            <textarea id=""Message"" required class=""form-control "" cols=""30"" rows=""8""></textarea>
                        </div>
                    </div>
                    <div class=""row"">
                        <div class=""col-md-6 form-group"">
                            <button type=""button"" id=""Send"" class=""btn btn-outline-black px-3 py-3"">Gönder</button>
                        </div>
                    </div>
                </form>
            </div>
  ...
  ");
    ...
    <script>
        ...
        /*function asd() {
            ...
            var inputText1 = $('#Name').val();
            alert(inputText1.value);


            var inputText2 = $('#Surname').val();
            alert(inputText2.value);

            var inputText3 = $('#Email').val();
            alert(inputText3.value);


            var inputText4 = $('Phone').val();
            alert(inputText4.value);

            var inputText5 = $('About').val();
            alert(inputText5.value);

            var inputText6 = $('#Message').val();
            alert(inputText6.value);
            alert(inputText7);  */


        $(""#Send"").click(function () {
            var Informations = {};
            Informations.Name = $('#Informations #Name').val();
            Informations.Surname = $(");
                WriteLiteral(@"'#Informations #Surname').val();
            Informations.Email = $('#Informations #Email').val();
            Informations.Phone = $('#Informations #Phone').val();
            Informations.About = $('#Informations #About').val();
            Informations.Message = $('Informations #Message').val();
            $.ajax({
                method: ""GET"",
                url: ""/Home/FormEvents"",
